...
public class PColor {
    ...
    // Prints out a Processing color int with separate red, green, and blue values
    ...
    // Prints out a Processing color int with hexadecimal values as used in Processing and commonly on the web
    public static void printHexColor(int color){
        int regularColor = (int)((long)Math.pow(16,6) + color);
        System.out.println("Pixel color in hex --> #" + String.format("0x%06X", regularColor).substring(2));
    }
